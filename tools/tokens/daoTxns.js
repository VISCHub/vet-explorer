...
if (typeof web3 !== "undefined") {
  ...
  web3 = new Web3(new Web3.providers.HttpProvider(process.env.NODE_URL || 'http://localhost:8545'));
}
...
var patchBlocks = function (max, min) {
  ...
  }, "number timestamp").lean(true).exec(function (err, docs) {
    async.forEach(docs, function (doc, cb) {
      var q = {
        'timestamp': null,
        'blockNumber': doc.number
      };
